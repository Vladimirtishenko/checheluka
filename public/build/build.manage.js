	            ...
	            function templates(data) {
	                ...
	                function ordersOne(goods) {
	                    ...
	                    for (var key in goods) {
	                        ...
	                        tmp += '<tr>' + '<td>' + decodeURIComponent(goods[key].art) + ' / ' + decodeURIComponent(goods[key].title) + '</td>' + '<td>' + decodeURIComponent(goods[key].size) + '</td>' + '<td>' + goods[key].count + '</td>' + '<td>' + goods[key].price + '</td>' + '</tr>';
	                    }
