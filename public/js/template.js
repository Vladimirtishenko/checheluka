		...
		return '<div class="a-general-goods a-animates-top-goods">' + 
				  ...
				  '<div class="a-general-goods__description">' +
				    ...
				    '<div class="a-for-mobile-absolute">' +
				      ...
				      '<p class="a-info-about-rates">Система повышает ставки автоматически на 30 рублей, если хотите повысить ставку сразу нажмите на одну из кнопок ниже!</p>' +
				      '<div class="a-general-goods__description_rates_button">' +
				        '<button class="a-button-white">+ 50 руб.</button>' +
				        '<button class="a-button-white">+ 100 руб.</button>' +
				        '<button class="a-button-white">+ 250 руб.</button>' +
